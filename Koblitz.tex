...
\newcommand{\snr}{|\phantom{x}|}
\newcommand{\dnr}{||\phantom{x}||}
...
\LARGE
\textbf{$p$-adic Numbers, $p$-adic Analysis, and Zeta-Functions, Exercise Solutions}
