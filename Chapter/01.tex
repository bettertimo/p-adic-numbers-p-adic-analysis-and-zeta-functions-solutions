...
Now, let $0\neq\alpha\in\QQ_p$ be arbitrary. Note that the parities of $m$ and the values of $(a_{-m}/p)$ give us four cases. With this in mind, we take $1\leq b\leq p-1$ s.t. $(b/p)=-1$. And define these four numbers as $1,b,p,bp$. Then we have
\begin{alignat*}{2}
...
Now, let $0\neq\alpha\in\QQ_2$ be arbitrary. Note that the parities of $m$ and the values of $a_{-m+1},a_{-m+2}$ give us eight cases. With this in mind, we define these eight numbers as $1,1+2,1+2^2,1+2+2^2,2,(1+2)2,(1+2^2)2,(1+2+2^2)2$. And the following tables indicate which number is the only square in the given case:
$$
\def\arraystretch{1.2}
\begin{array}{c|c|c}
